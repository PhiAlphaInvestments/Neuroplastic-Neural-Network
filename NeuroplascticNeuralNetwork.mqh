//+------------------------------------------------------------------+
//|                                   NeuroplascticNeuralNetwork.mqh |
//|                                                                  |
//|                                             https://www.mql5.com |
//+------------------------------------------------------------------+
...
class NeuroplascticNeuralNetwork{
      ...
      public:
         ...
         NeuroplascticNeuralNetwork(int in_DimensionRow,int in_DimensionCol,int Number_of_Neurons,int out_Dimension,double alpha,double LearningRate,bool Verbose,double beta_1, double beta_2,int max_iterations,double Sto_a_Min,double Sto_a_Max);
...
bool NeuroplascticNeuralNetwork::LoadWeights(void){
...
bool NeuroplascticNeuralNetwork::WriteWeights(void){
...
void NeuroplascticNeuralNetwork::ResetWeights(void){
...
void NeuroplascticNeuralNetwork::ComputeDerivatives(matrix &Input , matrix &y_){
...
NeuroplascticNeuralNetwork::NeuroplascticNeuralNetwork(int in_DimensionRow,int in_DimensionCol,int Number_of_Neurons,int out_Dimension,double alpha,double LearningRate,bool Verbose,double beta_1, double beta_2,int max_iterations,double Sto_a_Min,double Sto_a_Max) {
...
matrix NeuroplascticNeuralNetwork::Prediction(matrix& Input){
...
void NeuroplascticNeuralNetwork::Train(matrix &Input,matrix &correct_Val,double Sto_a_Min,double Sto_a_Max){
      m_Sto_Range_a_Max =Sto_a_Max;
      m_Sto_Range_a_Min = Sto_a_Min;
...
double NeuroplascticNeuralNetwork::Cost(matrix &Input , matrix &y_){
...
matrix NeuroplascticNeuralNetwork::Forward_Prop(matrix& Input){
...
double NeuroplascticNeuralNetwork::SigmoidReg(double x) {
...
double NeuroplascticNeuralNetwork::Sigmoid(double x) {
       int error;
...
double NeuroplascticNeuralNetwork::Sigmoid_Prime(double x){
      int error; 
       double a = MathRandomUniform(m_Sto_Range_a_Min,m_Sto_Range_a_Max,error);
...
int NeuroplascticNeuralNetwork::Sgn(double Value){
...
void NeuroplascticNeuralNetwork::MatrixRandom(matrix& m)
 {
   int error;
...
matrix NeuroplascticNeuralNetwork::MatrixSigmoid(matrix& m)
 {
  matrix m_2;
 ...
 matrix NeuroplascticNeuralNetwork::MatrixSigmoidRed(matrix& m)
 {
  matrix m_2;
  m_2.Init(m.Rows(),m.Cols());
  for(ulong r=0; r<m.Rows(); r++)
...
matrix NeuroplascticNeuralNetwork::MatrixSigmoidPrime(matrix& m)
{
  matrix m_2;
  m_2.Init(m.Rows(),m.Cols());
  for(ulong r=0; r<m.Rows(); r++)
